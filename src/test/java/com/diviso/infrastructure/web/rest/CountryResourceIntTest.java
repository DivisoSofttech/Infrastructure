...
import com.diviso.infrastructure.domain.Country;
import com.diviso.infrastructure.repository.CountryRepository;
import com.diviso.infrastructure.service.CountryService;
import com.diviso.infrastructure.service.dto.CountryDTO;
import com.diviso.infrastructure.service.mapper.CountryMapper;
...
public class CountryResourceIntTest {
    ...
    public void createCountry() throws Exception {
        ...
        assertThat(testCountry.getSortName()).isEqualTo(DEFAULT_SORT_NAME);
    ...
    public void getAllCountries() throws Exception {
        ...
        restCountryMockMvc.perform(get("/api/countries?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].sortName").value(hasItem(DEFAULT_SORT_NAME.toString())))
    ...
    public void getCountry() throws Exception {
        ...
        restCountryMockMvc.perform(get("/api/countries/{id}", country.getId()))
            ...
            .andExpect(jsonPath("$.sortName").value(DEFAULT_SORT_NAME.toString()))
    ...
    public void updateCountry() throws Exception {
        ...
        Country testCountry = countryList.get(countryList.size() - 1);
        assertThat(testCountry.getSortName()).isEqualTo(UPDATED_SORT_NAME);
